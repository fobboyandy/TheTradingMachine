...
void IBInterface::reqCurrentTime()
{
...
void IBInterface::tickDataOperation()
{
...
void IBInterface::marketDepthOperations()
{
...
void IBInterface::marketDataType()
{
	//! [reqmarketdatatype]
...
void IBInterface::historicalDataRequests()
{
...
void IBInterface::optionsOperations()
{
	//! [reqsecdefoptparams]
...
void IBInterface::contractOperations()
{
...
void IBInterface::marketScanners()
{
...
void IBInterface::reutersFundamentals()
{
...
void IBInterface::accountOperations()
{
...
void IBInterface::orderOperations()
{
...
void IBInterface::conditionSamples()
{
...
void IBInterface::bracketSample() {
	Order parent;
	Order takeProfit;
	Order stopLoss;
	//! [bracketsubmit]
...
void IBInterface::testAlgoSamples() {
	//! [algo_base_order]
...
void IBInterface::financialAdvisorOrderSamples()
{
	//! [faorderoneaccount]
...
void IBInterface::financialAdvisorOperations()
{
...
void IBInterface::testDisplayGroups() {
	//! [querydisplaygroups]
...
//! [error]
void IBInterface::error(const int id, const int errorCode, const std::string errorString)
{
...
void IBInterface::updateMktDepthL2(TickerId id, int position, std::string marketMaker, int operation,
...
void IBInterface::deltaNeutralValidation(int reqId, const UnderComp& underComp) {
...
void IBInterface::securityDefinitionOptionalParameter(int reqId, const std::string& exchange, int underlyingConId, const std::string& tradingClass, const std::string& multiplier, std::set<std::string> expirations, std::set<double> strikes) {
